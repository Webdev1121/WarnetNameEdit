...
if (color === null || !isNaN(color)){
    while (color !== null || isNaN(color)){
        alert("Invalid , please try again");
        getName = prompt("Mau Warna Apa ? Ketik Warna HTML nya di Gugel, contoh,<#fffff> , WAJIB MENAMBAHKAN < DAN > !  ");
        console.log(color)
       if (color !== null || !isNaN(color)){
           document.write();
           break;
...
var brcolor = prompt("Warna Line Ke 2 / Warna < br> tag, Klik OK Jika tidak Mau, CONTOH INPUT,<#000000>");


if (brcolor === null || !isNaN(brcolor)){
    while (brcolor !== null || isNaN(brcolor)){
        alert("Invalid , please try again");
        brcolor = prompt("Warna Line Ke 2 / Warna < br> tag, Klik OK Jika tidak Mau, CONTOH INPUT,<#000000>");
        console.log(brcolor)
       if (brcolor !== null || !isNaN(brcolor)){
           document.write();
           break;
